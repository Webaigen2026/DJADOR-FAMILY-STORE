  ...
  switch (status) {
    ...
    case "RETURNED":
      return {
        title: "Item returned",
        description:
          "Your returned item has been received and processed.",
        className:
          "border-blue-200 bg-blue-50 text-blue-900",
        iconClassName: "bg-blue-100 text-blue-700",
        icon: PackageSearch,
...
function getStoppedStatusText(status: OrderStatus) {
  switch (status) {
    case "CANCELLED":
      return "cancelled";

    case "RETURN_REQUESTED":
      return "in the return process";
